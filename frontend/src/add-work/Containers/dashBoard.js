                ...
                <div className='widgetsContainer2'>
                    ...
                    <div className='widgetsContainer6'>
                        <div className={`widget4 ${this.state.isCardFliped4 ? 'flip' : ''}`} onClick={() => this.flipCard4()}>
                            <Widgets className={'wid4'} width={"22vw"} height={"40vh"} title={"CAPITALISATION"} backText={"Ce widget présente un diagramme circulaire représentant les 10 plus grosses cryptomonnaies selon leur taille en capitalisation boursière."} widgetType={"CAP"} data={top10Data} />
                        </div>
