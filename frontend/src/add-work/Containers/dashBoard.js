                ...
                <div className='widgetsContainer4'>
                    <div className='widgetsContainer1'>
                        <div className={`widget1 ${this.state.isCardFliped1 ? 'flip' : ''}`} onClick={() => this.flipCard1()}>
                            <Widgets width={"50vh"} height={"60vh"} title={"TOP 10"} backText={"Ce widget présente le Top 10 des crypto-monnaies avec la plus grande capitalisation de marché. Pour chaque crypto-monnaie, on retrouveson logo, son nom, son prix actuel et son evolution en pourcentage sur 24H."} coins={coins}/>
                        </div>
                    </div>
