                ...
                <div className='widgetsContainer2'>
                    <div className='widgetsContainer5'>
                            <div className={`widget2 ${this.state.isCardFliped2 ? 'flip' : ''}`} onClick={() => this.flipCard2()}>
                                <Widgets width={"22vw"} height={"40vh"} title={"NEWS"} backText={"Ce widget présente les une nouvelle de l'actualité des crypto-monnaies. En cliquant sur le lien, une page s'ouvre vers l'article. "} widgetType={"NEWS"} data={news}/>
                            </div>
